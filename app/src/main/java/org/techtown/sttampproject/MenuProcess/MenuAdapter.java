...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.CustomViewHolder> {
    ...
    public MenuAdapter(Context context, ArrayList<MenuDataClass> list){
       mList = list;
       mContext = context;
    }
    ...
    @NonNull
    @Override
    public MenuAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MenuAdapter.CustomViewHolder customViewHolder, int position) {
